...
export default function Sidebar({ activeTab, setActiveTab, deferredPrompt, onInstall, onLogout }) {
  return (
    <nav className="hidden md:flex flex-col w-64 bg-white shadow-[4px_0_24px_rgba(0,0,0,0.02)] border-r border-gray-100 fixed top-0 bottom-0 left-0 z-40">
      ...
      <div className="p-4 border-t border-gray-100">
        {deferredPrompt && (
          <button onClick={onInstall} className="w-full mb-3 flex items-center justify-center space-x-2 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 px-4 py-2.5 rounded-xl font-semibold transition-colors text-sm">
        ...
        <button onClick={onLogout} className="w-full flex items-center justify-center space-x-2 text-rose-500 hover:bg-rose-50 px-4 py-2.5 rounded-xl font-bold transition-colors">
