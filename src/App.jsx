...
export default function App() {
  ...
  const handleSimpanSantri = async (e) => {
    ...
    const newSantri = { ...formSantri, id: Date.now(), ustadz_email: user?.email };
  ...
  const handleSimpanAbsen = async (santriId, status) => {
    ...
    const absenBaru = { id: Date.now(), santri_id: santriId, status, tanggal: tanggalHariIni, ustadz_email: user?.email };
  ...
  const handleSimpanBatasAjar = async (e) => {
    ...
    const newBatas = { id: Date.now(), fan: formBatas.fan, batas_akhir: formBatas.batas, created_at: new Date().toISOString(), ustadz_email: user?.email };
  ...
  const handleSimpanPerilaku = async (e) => {
    ...
    const newPrilaku = { id: Date.now(), santri_id: parseInt(formPerilaku.santri_id), catatan: formPerilaku.catatan, created_at: new Date().toISOString() };
  ...
  const handleSimpanNilai = async (e) => {
    ...
    const newNilai = { id: Date.now(), santri_id: parseInt(formNilai.santri_id), jenis_ujian: formNilai.jenis_ujian, pelajaran: formNilai.pelajaran, skor: parseInt(formNilai.skor) };
  ...
  const handleSimpanSoal = async (e) => {
    ...
    const newSoal = { id: Date.now(), pelajaran: formSoal.pelajaran, kelas: formSoal.kelas, batasan: formSoal.batasan, isi_soal: formSoal.isi };
